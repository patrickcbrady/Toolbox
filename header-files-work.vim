...
silent only
cd /mnt/c/Users/Lori/Desktop/Engineering/ToolBox
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 FreshenUp.bat
badd +0 FreshenUpConfig.bat
badd +0 forceScrollbars.js
argglobal
silent! argdel *
$argadd FreshenUp.bat
set stal=2
edit FreshenUp.bat
